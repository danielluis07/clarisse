    ...
    <Link href={href} className="group/card block">
      <div className="group/image relative aspect-3/4 w-full overflow-hidden bg-foreground/3">
        <Image
          ...
          className="object-cover transition-transform duration-900 ease-out group-hover/image:scale-[1.03]"
        />
        {hoverImage && (
          <Image
            src={hoverImage}
      ...
      <span className="mt-4 flex items-center justify-center gap-2 border border-foreground/15 px-4 py-3 text-[11px] uppercase tracking-[0.22em] text-foreground/75 transition-colors group-hover/card:border-foreground group-hover/card:text-foreground">
        Ver detalhes
